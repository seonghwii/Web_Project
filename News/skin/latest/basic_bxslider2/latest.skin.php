...
?>
<h2 style="padding-bottom:10px;border-bottom:1px solid #cccccc"><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>">
<span style="font-size:16px"><b><?php echo $bo_subject; ?></b></span></a></h2>
				...
				<div id="<?php echo $slide;?>" class="clear_fix latest_list">
					<ul>
						...
						<li class="clear_fix">
							...
							<a href="<?php echo $list[$i][href];?>"><span style="font-size:16px;font-weight:bold;color:#000000;line-height:120%">
								<?php
								if ($list[$i]['is_notice'])
							...
							<div style="color:#666666"><?php
							$list[$i]['wr_content']=str_replace("&nbsp;"," ",$list[$i]['wr_content']);
							echo cut_str(strip_tags(stripslashes($list[$i]['wr_content'])),100); ?></div>
