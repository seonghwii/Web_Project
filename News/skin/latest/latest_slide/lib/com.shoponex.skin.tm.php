...
// 게시글리스트 썸네일 생성
function get_list_thumbnail_tm($bo_table, $wr_id, $thumb_width, $thumb_height, $is_create=false, $is_crop=true, $crop_mode='center', $is_sharpen=false, $um_value='80/0.5/3')
{
    global $g5, $config;
    $filename = $alt = "";
    $edt = false;
    ...
    $thumb = array("src"=>$src, "ori"=>$ori, "alt"=>"fdfdsfdsfs", "class"=>"dfdsfdsf");
