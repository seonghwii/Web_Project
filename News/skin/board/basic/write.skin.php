...
<section id="bo_w">
    ...
    <?php if ($is_admin) { ?>
    <div class="write_div">
        <label for="r_wr_datetime" class="sound_only">등록날짜</label>
        <input type="text" name="r_wr_datetime" value="<?php echo $write[wr_datetime] ?>" id="r_wr_datetime" class="frm_input full_input" size="50" placeholder="등록날짜">
		<div >미등록시 현재날짜로 입력됩니다.<br>직접 입력시 [년-월-일]을 수정하시면 됩니다.<br> [시:분:초]는 노출을 안 시킬예정입니다.  <span style="color:#ff0000">2018-01-01 11:30:30</span>  <div>
    </div>
