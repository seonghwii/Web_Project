...
<?php } ?>
	...
	<div id="register_form" class="form_01">   
        ...
        <div class="tbl_frm01 tbl_wrap register_form_inner">
            ...
            <ul>
               <li>
                     <label for="reg_mb_account">은행명<strong class="sound_only">필수</strong></label>
                    <select name="mb_1" class="frm_input">
                        <option value=""  class="frm_input">은행선택</option>
                        <option value="기업은행" <?if($memeber['mb_1']=='기업은행') echo "selected";?>>기업은행</option>
                        <option value="신한은행" <?if($memeber['mb_1']=='신한은행') echo "selected";?>>신한은행</option>
                    </select>
                
                </li>
                
                <li>
                   <label for="reg_mb_account">계좌번호<strong class="sound_only">필수</strong></label>
                   <input type="text" id="reg_mb_account" name="mb_account" value="<?php echo get_text($member['mb_account']) ?>" <?php echo $readonly; ?> class="frm_input full_input <?php echo $readonly ?>" size="10" placeholder="계좌번호">
                </li>
                
                <li>
                   <label for="reg_mb_account2">예금주<strong class="sound_only">필수</strong></label>
                   <input type="text" id="reg_mb_account2" name="mb_account2" value="<?php echo get_text($member['mb_account2']) ?>" <?php echo $readonly; ?> class="frm_input full_input <?php echo $readonly ?>" size="10" placeholder="예금주">
                </li>
