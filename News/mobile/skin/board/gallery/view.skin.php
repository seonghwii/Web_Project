...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        ...
        <p><span class="sound_only">작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo date("y-m-d", strtotime($view['wr_datetime'])) ?></p>
    </header>
    ...
    <section id="bo_v_atc">
        ...
        ?>
		<div style="float:right"><span style="font-size:11px;color:#666666">뉴스윈(jebo777@hanmail.net)</span></div>
        <div id="bo_v_share" style="clear:both">
